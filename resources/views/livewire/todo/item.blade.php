<div class="flex gap-2 text-red-50">
    <label class="flex justify-start items-center @if ($todo->checked) opacity-30 @endif"></label>
    <div class="
        border-2 rounded-full border-purple-700 w-12 h-12
    ...
    <div class="
        select-none  text-gray-50 tracking-wider
        @if ($todo->checked) line-through opacity-25 @else @endif
    ">
